...
const children = [
  {
    ...
    recentGrades: [
      { subject: "Mathématiques", grade: 14.5, date: "Il y a 2 jours" },
      { subject: "Français", grade: 16.5, date: "Il y a 3 jours" },
      { subject: "Lingala", grade: 17.0, date: "Il y a 1 semaine" },
    ],
  },
  {
    name: "Merveille Ngoy",
    ...
    recentGrades: [
      { subject: "Mathématiques Avancées", grade: 13.2, date: "Il y a 1 jour" },
      { subject: "Physique", grade: 15.5, date: "Il y a 4 jours" },
      { subject: "Chimie", grade: 12.8, date: "Il y a 1 semaine" },
    ],
  },
];
...
const upcomingEvents = [
  {
    date: "30 Juin",
    event: "Célébration Indépendance RDC",
    child: "Divine Kabila",
    time: "08:00",
    type: "activity",
  },
  ...
  {
    date: "18 Mars",
    event: "Examen Mathématiques Avancées",
    child: "Merveille Ngoy",
    time: "10:00",
    type: "exam",
  },
  {
    date: "25 Mars",
    event: "Visite Musée National Kinshasa",
    child: "Divine Kabila",
    time: "9:00",
    type: "activity",
  },
  {
    date: "1 Avril",
    event: "Conférence sur Patrice Lumumba",
    child: "Merveille Ngoy",
    time: "14:00",
    type: "activity",
  },
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 shrink-0">
            <Button className="bg-blue-600 hover:bg-blue-700 text-sm h-9">
              ...
              <span className="hidden sm:inline">Contacter </span>l'école
            </Button>
